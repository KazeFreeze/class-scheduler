        ...
        >
            ...
            >
                ...
                <div className="mt-6 pt-4 border-t flex flex-col sm:flex-row gap-3">
                    ...
                    <a href={COFFEE_LINK} target="_blank" rel="noopener noreferrer" className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-yellow-400 text-yellow-900 font-semibold rounded-lg hover:bg-yellow-500 transition-colors">
                        <Coffee size={20} />
